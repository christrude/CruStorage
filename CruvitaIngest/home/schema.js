...
HomeSchema.index({'listing.listingcategory': 1, 'status': 1, 'listing.location.latitude': 1, 'listing.location.longitude': 1, 'cruvitaDate': -1 });
HomeSchema.index({'schools.high': 1, 'listing.listingcategory': 1,'cruvitaDate': -1 });
HomeSchema.index({'schools.middle': 1, 'listing.listingcategory': 1,'cruvitaDate': -1 });
HomeSchema.index({'schools.elementary': 1, 'listing.listingcategory': 1,'cruvitaDate': -1 });
HomeSchema.index({'listing.listingcategory': 1, 'status': 1, 'locations.city': 1, 'cruvitaDate': -1 });
HomeSchema.index({'listing.listingcategory': 1, 'status': 1, 'locations.zip': 1, 'cruvitaDate': -1 });
HomeSchema.index({'listing.listingcategory': 1, 'status': 1, 'locations.state': 1, 'cruvitaDate': -1});
HomeSchema.index({'listing.listingcategory': 1, 'status': 1, 'locations.county': 1, 'cruvitaDate': -1 });
HomeSchema.index({'listing.listingcategory': 1, 'status': 1, 'schools.elementary': 1, 'cruvitaDate': -1 });
HomeSchema.index({'listing.listingcategory': 1, 'status': 1, 'schools.middle': 1, 'cruvitaDate': -1 });
HomeSchema.index({'listing.listingcategory': 1, 'status': 1, 'schools.high': 1, 'cruvitaDate': -1 });
HomeSchema.index({"listing.listingkey": 1});
HomeSchema.index({'listing.address.postalcode': 1 });
HomeSchema.index({'slug': 1 });
HomeSchema.index({'ingestDate': 1 });
HomeSchema.index({'listing.address.stateorprovince': 1, 'listing.address.city': 1, 'listing.address.postalcode': 1 });
